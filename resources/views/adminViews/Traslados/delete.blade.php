<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_traslados}}">
{{Form::Open(array('action'=>array('AdminTrasladosController@destroy',$item->id_traslados),'method'=>'delete'))}}
