<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_atractivos}}">
{{Form::Open(array('action'=>array('AdminAtractivosController@destroy',$item->id_atractivos),'method'=>'delete'))}}
