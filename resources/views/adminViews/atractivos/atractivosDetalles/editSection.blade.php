...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::model($atractivos,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','action'=>['AdminAtractivosDetalleController@update',$atractivos->id_atractivosdetalles]))!!} 
            {{Form::token()}}
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    <input type="text" class="form-control" name="tituloSeccion" value="{{$atractivos->titulo}}">
                                    {!! $errors->first('tituloSeccion','<span class="help-block">Es necesario introducir un texto lateral</span>')!!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control summernote" name="textolateral" id="textolateral" cols="30" rows="15">{{ $atractivos->textolateral }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control summernote" name="textopie" id="textopie" cols="30" rows="15">{{$atractivos->textopie}}</textarea>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Descripción de imagen</label>
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control summernote" name="descImagen" id="descImagen" cols="30" rows="15">{{$atractivos->descimagen}}</textarea>
                                    {!! $errors->first('descImagen','<span class="help-block">Es necesario introducir un texto de pié</span>')!!}
                                </div>
                            </div>
                        </div>
