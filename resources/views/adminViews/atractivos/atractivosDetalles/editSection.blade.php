                ...
                <input name="atractivoActual" name="atractivoActual" type="hidden" value="{{$atractivoActual}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control" name="textolateral" id="textolateral" cols="30" rows="15">{{ $atractivos->textolateral }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control" name="textopie" id="textopie" cols="30" rows="15">{{$atractivos->textopie}}</textarea>
