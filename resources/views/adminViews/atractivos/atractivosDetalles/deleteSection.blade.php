<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_atractivosdetalles}}">
{{Form::Open(array('action'=>array('AdminAtractivosDetalleController@destroy',$item->id_atractivosdetalles),'method'=>'delete'))}}
