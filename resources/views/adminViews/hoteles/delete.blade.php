<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->idHotel}}">
{{Form::Open(array('action'=>array('AdminHotelesController@destroy',$item->idHotel),'method'=>'delete'))}}
