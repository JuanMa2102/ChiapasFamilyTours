...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::model($informacion,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','action'=>['AdminGaleriaController@update',$informacion->id_galeria]))!!} {{Form::token()}}
                ...
                <div class="row">
                    <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            <a href="{{URL::action('AdminGaleriaController@show',$diaActual)}}"><button type="button" class="btn btn-default"><i class="fa fa-mail-reply"></i> Atrás</button></a>
