<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_clientes}}">
{{Form::Open(array('action'=>array('AdminClientesController@destroy',$item->id_clientes),'method'=>'delete'))}}
