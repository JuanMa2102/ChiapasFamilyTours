...
<div class="page-content-wrap">
    ...
    <div class="row">
        ...
        {!!Form::model($clientes,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','action'=>['AdminClientesController@update',$clientes->id_clientes]))!!}  {{Form::token()}}
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                ...
                                <input value="{{$clientes->nombre}}" name="nombre" type="text" class="form-control" />
                            </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control summernote" name="mensaje" id="mensaje" cols="30" rows="15">{{$clientes->mensaje}}</textarea>
