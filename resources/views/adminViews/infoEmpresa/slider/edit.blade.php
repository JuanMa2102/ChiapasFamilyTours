...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::model($slider,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','files'=>'true','action'=>['AdminSliderController@update',$slider->id_slider]))!!} 
            {{Form::token()}}
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Editando - {{$slider->titulo}}</strong></h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                ...
                                <input value="{{ $slider->titulo }}" name="tituloP" type="text" class="form-control" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input value="{{ $slider->subtitulo }}" name="subtituloP" type="text" class="form-control" />
                            </div>
                        </div>
                    </div>
