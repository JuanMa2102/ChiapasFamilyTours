<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_preguntaFrecuente}}">
{{Form::Open(array('action'=>array('AdminPreguntasFrecuentesController@destroy',$item->id_preguntaFrecuente),'method'=>'delete'))}}
