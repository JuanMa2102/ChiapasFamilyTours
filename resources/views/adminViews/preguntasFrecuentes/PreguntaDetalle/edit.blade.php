...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::model($informacion,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','files'=>'true','action'=>['AdminPreguntasFrecuentesDetalleController@update',$informacion->id_preguntasFrecuentesDetalle]))!!} 
            {{Form::token()}}
                ...
                <div class="seccionItinerario">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                ...
                                <input name="titulo" type="text" class="form-control" value="{{$informacion->titulo}}" />
                            </div>
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input name="tituloImagen" type="text" class="form-control" value="{{$informacion->infoImagen}}" />
                            </div>
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input name="fuente" type="text" class="form-control" value="{{$informacion->fuente}}" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    <textarea class="form-control summernote" name="descripcion" id="textolateral" cols="30" rows="15">{{$informacion->descripcion}}</textarea>
