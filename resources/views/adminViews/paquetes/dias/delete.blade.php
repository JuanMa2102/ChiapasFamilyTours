<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_dias}}">
{{Form::Open(array('action'=>array('AdminDiasController@destroy',$item->id_dias),'method'=>'delete'))}}
