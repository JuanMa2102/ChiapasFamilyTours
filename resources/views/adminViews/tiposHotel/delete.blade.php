<div class="message-box message-box-danger animated fadeIn" id="message-box-danger-{{$item->id_tipoHotel}}">
{{Form::Open(array('action'=>array('AdminTiposHotelesController@destroy',$item->id_tipoHotel),'method'=>'delete'))}}
