...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!!Form::model($tipos,array('method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data','action'=>['AdminTiposHotelesController@update',$tipos->id_tipoHotel]))!!} {{Form::token()}}
            {{Form::token()}}
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Editando {{$tipos->descripcion}}</strong></h3>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                ...
                                <input name="tipo" type="text" class="form-control" value="{{$tipos->descripcion}}"/>
                            </div>
