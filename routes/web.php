...
Route::get('administrador/adminActividadAventura','adminActividadAventuraController@index');
Route::get('administrador/create-actividad-aventura','adminActividadAventuraController@create');
Route::get('administrador/edit-actividad-aventura/{id}','adminActividadAventuraController@edit');
Route::post('administrador/creating-actividad-aventura','adminActividadAventuraController@store');
Route::post('administrador/updating-actividad-aventura/{id}','adminActividadAventuraController@update');
Route::post('administrador/delete-actividad-aventura/{id}','adminActividadAventuraController@destroy');
